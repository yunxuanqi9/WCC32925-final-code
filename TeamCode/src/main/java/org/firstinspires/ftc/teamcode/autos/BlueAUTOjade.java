...
public class BlueAUTOjade extends NextFTCOpMode {
    ...
    public void buildPaths() {
        Path1 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierLine(
                ...
                .build();
        Path2 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(58.332, 96.901),
                ...
                .build();
        Path3 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierLine(
                                new Pose(17.754, 83.182),
                ...
                .setReversed()
                .build();
        Path4 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(66.055, 80.252),
        ...
        Path5 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(13.963, 62.833),
        ...
        Path6 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(62.400, 22.330),
                ...
                .build();
        Path7 = PedroComponent.follower().pathBuilder().addPath(
                        new BezierLine(
                                new Pose(15.513, 35.417),
